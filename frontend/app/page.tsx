      ...
      <AppShell>
        <div className="border-b border-cream-border bg-cream-card px-4 md:px-6 py-3 flex flex-col sm:flex-row gap-3 sm:items-center sm:justify-between">
          ...
          <a
            href="/login"
            title="Account"
            className="w-9 h-9 rounded-full bg-accent flex items-center justify-center text-white font-semibold text-sm hover:bg-accent-hover transition-colors flex-shrink-0"
          >
